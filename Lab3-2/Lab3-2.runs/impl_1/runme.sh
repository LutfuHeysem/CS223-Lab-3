...
HD_PWD='C:/Users/LHeysemK/Desktop/CS223/Labs/Lab 3/Lab3-2/Lab3-2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoToFourDecoderBehavioral.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwoToFourDecoderBehavioral.tcl -notrace
