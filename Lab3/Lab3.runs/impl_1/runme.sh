...
HD_PWD='C:/Users/LHeysemK/Desktop/CS223/Labs/Lab 3/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BitShifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BitShifter.tcl -notrace
