...
HD_PWD='C:/Users/LHeysemK/Desktop/CS223/Labs/Lab 3/Lab3-4/Lab3-4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EightToOneMux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EightToOneMux.tcl
